...
struct Parameters {
  ...
  double host_epsilons[N_host] = {
    ...
    /*Tl*/ NAN, /*Pb*/ 333.635, /*Bi*/ 260.668, /*Po*/ 163.546, 
    ...
    /*Md*/ 5.53542, /*No*/ 5.53542,/*Lr*/ 5.53542, /*Rf*/ NAN, 
  ...
  double host_sigmas[N_host] = {
    ...
    /*Tl*/ NAN, /*Pb*/ 3.82819, /*Bi*/ 3.89323, /*Po*/ 4.19524, 
    ...
    /*Md*/ 2.9168, /*No*/ 2.89364, /*Lr*/ 2.88295, /*Rf*/ NAN, 
    /*Db*/ NAN, /*Sg*/ NAN, /*Bh*/ NAN, /*Hs*/ NAN,
    /*Mt*/ NAN, /*Ds*/ NAN, /*Rg*/ NAN, /*Cn*/ NAN,
    /*Nh*/ NAN, /*Fl*/ NAN, /*Mc*/ NAN, /*Lv*/ NAN, 
    /*Ts*/ NAN, /*Og*/ NAN,
